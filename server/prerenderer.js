...
var debug = require('debug')('menstackjs:prerenderer')
var MEN_STACK_UA = 'Men Stack Prerenderer'
...
function shouldRenderFromPhantom (req) {
  ...
  if (!userAgent || userAgent === MEN_STACK_UA) return false
