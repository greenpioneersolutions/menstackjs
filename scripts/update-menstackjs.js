...
request({
  json: true,
  url: 'https://raw.githubusercontent.com/greenpioneersolutions/menstackjs/master/package.json'
  ...
  spawn('git', ['pull', 'https://github.com/greenpioneersolutions/menstackjs', 'master'], {
    stdio: 'inherit'
  })
})
